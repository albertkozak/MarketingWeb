...
const DeleteVenue = (props) => {
    ...
    const BASE_URL = "https://atackmarketingapi.azurewebsites.net/api/Venues/remove/"
...
<div className="container">
    ...
    <div className="vendorFormDelete">
        ...
        />
        <input
            placeholder={currentVenue.website}
        />

		<div className="buttons">
            <button className="submit"
                onClick={e =>
                    window.confirm("Are you sure you wish to delete this venue") && deleteVenue()}
                >
                    Delete
                </button>

                <button className="cancel" variant="" type="submit" onClick={() => history.push('/venues')}>
                    Cancel
                </button>
