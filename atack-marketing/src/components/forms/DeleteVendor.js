...
<div className="container">
    ...
    <div className="vendorFormDelete">
            ...
            <input
                    ...
                    />
                    <input
                        placeholder={currentVendor.description}
                    />
                    <input
                        placeholder={currentVendor.email}
                    />
                                        <input
                        placeholder={currentVendor.website}
                    />

					<div className="buttons">
                    <button className="submit"
                            onClick={e =>
                                window.confirm("Are you sure you wish to delete this vendor") && deleteVendor()}
                        >
                            Delete
                        </button>

                        <button className="cancel" variant="" type="submit" onClick={() => history.push('/vendors')}>
                            Cancel
                        </button>
